...
%==========================================================================
matlabbatch{5}.spm.util.voi.spmmat = cellstr(fullfile(data_path,'GLM','SPM.mat')); %choose mat file
matlabbatch{5}.spm.util.voi.adjust = 1; %effect of interest (F test) 
matlabbatch{5}.spm.util.voi.session = 1;
matlabbatch{5}.spm.util.voi.name = 'V2';
matlabbatch{5}.spm.util.voi.roi{1}.spm.spmmat = {''}; %present mat file
...
matlabbatch{5}.spm.util.voi.roi{2}.sphere.move.local.spm = 1;%Fixed
